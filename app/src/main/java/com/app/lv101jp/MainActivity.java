...
public class MainActivity extends Activity {
    ...
    private static final String WEBSITE_URL = "file:///android_asset/lv101+.html";
    private static final String PREFS = "com.app.lv101jp.prefs";
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isEmulator()) { showSecurityAlert("This app cannot run on emulators."); return; }
    ...
    private void showOfflinePage(final WebView view) {
        runOnUiThread(new Runnable() { @Override public void run() {
            ...
            String html = "<!DOCTYPE html><html><head>"
                ...
                + "</body></html>";
            // Add bridge BEFORE loading HTML
    ...
    private void showSecurityAlert(String msg) {
